...
Only if both of the above conditions are met, return "Selected". Even if one of the conditions is not met, return "Rejected" in the candidate_status field.

While matching skills, consider the following:
- If the skills are related to the job description. For example, if the job description requires CI/CD and the candidate has DevOps experience, consider them as related.
